...
export default function Home() {
  return (
    <div className="bg-morena-dark">
      ...
      {/* ═══════════════════════════════ ABOUT — CTA with stagger animation ═══════════════════════════════ */}
      <section className="py-20 sm:py-28 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <ContainerStagger transition={{ delayChildren: 0.4 }}>
            <ContainerAnimated>
      ...
      {/* ═══════════════════════════════ CTA — animated stagger ═══════════════════════════════ */}
      <section className="py-20 sm:py-28 px-4">
        <ContainerStagger className="max-w-3xl mx-auto text-center">
          <ContainerAnimated>
